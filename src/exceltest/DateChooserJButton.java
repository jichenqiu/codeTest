...
public class DateChooserJButton extends JButton {  
    ...
    private class DateChooser extends JPanel implements ActionListener, ChangeListener {  
        ...
        private JPanel createYearAndMonthPanal() {  
            ...
            yearSpin.setPreferredSize(new Dimension(50, 25));  
            ...
            monthSpin.setPreferredSize(new Dimension(37, 25));  
            ...
            daySpin.setPreferredSize(new Dimension(37, 25));  
            daySpin.setName("Day");  
            ...
            hourSpin.setPreferredSize(new Dimension(37, 25));  
            ...
            minuteSpin.setPreferredSize(new Dimension(37, 25));  
            ...
            secondSpin.setPreferredSize(new Dimension(37, 25));  
